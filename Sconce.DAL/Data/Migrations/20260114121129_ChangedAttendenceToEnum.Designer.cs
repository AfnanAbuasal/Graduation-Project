...
namespace Sconce.DAL.Data.Migrations
{
    ...
    [Migration("20260114121129_ChangedAttendenceToEnum")]
    partial class ChangedAttendenceToEnum
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sconce.DAL.Models.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sconce.DAL.Models.InformationRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sconce.DAL.Models.Program", b =>
                {
                    ...
                    b.Property<int>("ActualLevelCount")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EvaluatorInstructorId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("ExamWriterInstructorId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<bool>("HasProficiencyExam")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("PlannedLevelCount")
                        .HasColumnType("int");

                    b.Property<int?>("ProficiencyExamId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EvaluatorInstructorId");

                    b.HasIndex("ExamWriterInstructorId");

                    b.HasIndex("ProficiencyExamId");

                    b.ToTable("Programs");
                });

            modelBuilder.Entity("Sconce.DAL.Models.ProgramEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EvaluatedByInstructorId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int?>("PlacedSectionId")
                        .HasColumnType("int");

                    b.Property<int?>("ProficiencyExamAttemptId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EvaluatedByInstructorId");

                    b.HasIndex("PlacedSectionId");

                    b.HasIndex("ProficiencyExamAttemptId");
            ...
            modelBuilder.Entity("Sconce.DAL.Models.StudentSection", b =>
                {
                    b.Property<string>("StudentId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Sconce.DAL.Models.Text", b =>
                {
                    b.HasBaseType("Sconce.DAL.Models.Content");
            ...
            modelBuilder.Entity("Sconce.DAL.Models.Answer", b =>
                {
                    b.HasOne("Sconce.DAL.Models.ExamAttempt", "ExamAttempt")
                        .WithMany()
            ...
            modelBuilder.Entity("Sconce.DAL.Models.Choice", b =>
                {
                    b.HasOne("Sconce.DAL.Models.MultipleChoiceQuestion", "MultipleChoiceQuestion")
                        .WithMany("Choices")
            ...
            modelBuilder.Entity("Sconce.DAL.Models.ExamAttempt", b =>
                {
                    ...
                    b.HasOne("Sconce.DAL.Models.Student", null)
                        .WithMany("ExamAttempts")
            ...
            modelBuilder.Entity("Sconce.DAL.Models.Program", b =>
                {
                    b.HasOne("Sconce.DAL.Models.Instructor", "EvaluatorInstructor")
                        .WithMany()
                        .HasForeignKey("EvaluatorInstructorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Sconce.DAL.Models.Instructor", "ExamWriterInstructor")
                        .WithMany()
                        .HasForeignKey("ExamWriterInstructorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Sconce.DAL.Models.Exam", "ProficiencyExam")
                        .WithMany()
                        .HasForeignKey("ProficiencyExamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("EvaluatorInstructor");

                    b.Navigation("ExamWriterInstructor");

                    b.Navigation("ProficiencyExam");
                });

            modelBuilder.Entity("Sconce.DAL.Models.ProgramEnrollment", b =>
                {
                    b.HasOne("Sconce.DAL.Models.Instructor", "EvaluatedByInstructor")
                        .WithMany()
                        .HasForeignKey("EvaluatedByInstructorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Sconce.DAL.Models.Section", "PlacedSection")
                        .WithMany()
                        .HasForeignKey("PlacedSectionId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Sconce.DAL.Models.ExamAttempt", "ProficiencyExamAttempt")
                        .WithMany()
                        .HasForeignKey("ProficiencyExamAttemptId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Sconce.DAL.Models.Course", "RecommendedCourse")
                        .WithMany()
                    ...
                    b.Navigation("EvaluatedByInstructor");

                    b.Navigation("PlacedSection");

                    b.Navigation("ProficiencyExamAttempt");
